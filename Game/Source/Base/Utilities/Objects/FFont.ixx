...
export namespace fbc {
    ...
    FFontRender FFont::makeTexture(strv text, uint32 w = 0, sdl::Color color = sdl::COLOR_WHITE, sdl::Color outlineColor = sdl::COLOR_BLACK, sdl::Color shadowColor = sdl::COLOR_BLACK_SHADOW)
    {

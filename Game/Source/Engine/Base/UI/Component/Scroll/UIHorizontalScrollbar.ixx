...
namespace fbc {
	...
	public:
		UIHorizontalScrollbar(FWindow& window, uptr<Hitbox>&& hb, IDrawable& imageBar = cct.images.uiScrollbar, IDrawable& imageButton = cct.images.uiScrollbutton) : UIScrollbar(window, move(hb), imageBar, imageButton) {

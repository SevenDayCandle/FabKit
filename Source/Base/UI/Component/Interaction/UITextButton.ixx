...
namespace fab {
	...
	public:
		...
		inline UITextButton& setColor(sdl::Color color) override { return text.setColor(color), *this; }
		inline UITextButton& setColorOutline(sdl::Color colorOutline) { return text.setColorOutline(colorOutline), *this; }
		inline UITextButton& setFont(FFont& font) { return text.setFont(font), *this; }
	...
	void UITextButton::renderImpl(BatchRenderPass& rp) {
		UIButton::renderImpl(rp);
		text.drawCenteredFull(rp, hb->cX(), hb->cY());
	}
}
